...
const Header = () => {
  ...
  return (
    <header className="flex justify-between items-center px-5 py-2 bg-primary text-white fixed top-0 left-0 right-0 z-10">
      ...
      {/* Resume Button */}
      <a href="https://drive.google.com/file/d/1vlPt-jvHzBgCGgSEV_3TyCu__LFdVlSK/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="ml-auto mr-5 md:mr-0">
